...
@extend_schema_view(
    list=extend_schema(
        ...
        description="Возвращает список всех магазинов. Можно добавить фильтры по полям.",
    ),
    retrieve=extend_schema(
...
@extend_schema_view(
    ...
    create=extend_schema(
        ...
        description="Принимает спрогнозированные значения для товара и ТЦ, сохраняет в БД",
